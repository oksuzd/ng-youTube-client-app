  ...
  items: [
    {
      ...
      id: 'YN8zNnV0sK8',
      snippet: {
        publishedAt: '2023-02-28T12:42:19.000Z',
        channelId: 'UCg8ss4xW9jASrqWGP30jXiw',
        title: 'Angular 8 - Быстрый курс за 60 минут',
        description:
          '30 мая 2019 года бы релиз Angular 8 и я решил записать  по нему быстрый курс. В видео вы узнаете' +
    ...
    },
    {
      ...
      id: 'Fdf5aTYRW0E',
      snippet: {
        publishedAt: '2023-02-14T17:46:58.000Z',
    ...
    },
    {
      ...
      snippet: {
        ...
        localized: {
          title: 'Angular 8 Основы. Полный Курс для начинающих',
          description:
            'Урок по Angular. В этом курсе вы познакомитесь со всеми основными элементами, которые есть в ' +
    ...
    },
    {
      ...
      id: 'm0yGx2MGZWg',
      snippet: {
        publishedAt: '2022-11-13T07:44:08.000Z',
        ...
        description:
          ...
          'где и когда его применяют, а так же сделаю небольшой обзор его возможностей. ' +
          'Расскажу чем фреймворк сложен для новичков и чем он действительно хорош для новых проектов. ' +
          'Сейчас для того что б стать junior javascript разработчиком нужно обязательно знать хотя бы один фреймворк js ' +
          'и ангуляр будет отличным выбором.',
        thumbnails: {
          default: {
    ...
    },
    {
      ...
      snippet: {
        ...
        description:
          ...
          "So in this video I really want to cover what exactly Angular is and why it's even necessary... " +
    ...
    },
    {
      ...
      id: 'u1VCxpvDgsk',
      snippet: {
        publishedAt: '2023-02-06T15:00:05.000Z',
        channelId: 'UCvuY904el7JvBlPbdqbfguw',
        title: 'Уроки Angular для начинающих / #1 - Введение в Angular',
        description:
          'Приступаем к изучению библиотеки Angular. В ходе курса мы создадим небольшой сайт и научимся ' +
          'всем основным концепциям библиотеки Angular. Мы рассмотрим события, компоненты, создание форм и многое другое, ' +
          'чтобы вы в дальнейшем сами могли создавать веб сайты на Angular.',
        thumbnails: {
          default: {
    ...
    },
    {
      ...
      id: 'G0bBLvWXBvc',
      snippet: {
        publishedAt: '2023-02-25T16:53:41.000Z',
